...
public enum CardAssetPath {
    public static let scheme = "ankountant-asset"
    public static let cardBaseURL = URL(string: "ankountant-asset://card/")!
    public static let mediaBaseURL = URL(string: "ankountant-asset://media/")!
    public static let mathJaxConfigScriptURLString = "ankountant-asset://assets/mathjax/mathjax.js"
    public static let mathJaxCoreScriptURLString = "ankountant-asset://assets/mathjax/vendor/tex-chtml-full.js"

    public static func mediaBaseTag() -> String {
        #"<base href="ankountant-asset://media/">"#
    }
