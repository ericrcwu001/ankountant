...
@Suite struct CardHTMLRewriterTests {
    ...
    @Test func soundMarkerBecomesButtonAndAudio() {
        ...
        #expect(output.contains("class=\"ankountant-play\""))
        #expect(output.contains("src=\"ankountant-asset://media/hello.mp3\""))
    ...
    @Test func multipleSoundsGetUniqueIds() {
        ...
        let idPattern = #"id="(ankountant-audio-[^"]+)""#
    ...
    @Test func filenameWithSpacesIsPercentEncoded() {
        ...
        #expect(output.contains("ankountant-asset://media/my%20sound.mp3"))
    }
    ...
    @Test func adjacentMarkersProduceTwoDistinctPlayers() {
        ...
        #expect(output.components(separatedBy: "class=\"ankountant-play\"").count - 1 == 2)
    ...
    @Test func bareImgSrcIsRewrittenToMediaScheme() {
        ...
        #expect(output.contains(#"src="ankountant-asset://media/photo.jpg""#))
    }
    ...
    @Test func multipleImagesInOneBodyAreAllRewritten() {
        ...
        #expect(output.contains(#"src="ankountant-asset://media/a.jpg""#))
        #expect(output.contains(#"src="ankountant-asset://media/b.jpg""#))
    }

    @Test func uppercaseImgTagIsRewritten() {
        let output = CardHTMLRewriter.rewrite(#"<IMG SRC="p.jpg">"#)
        #expect(output.contains("ankountant-asset://media/p.jpg"))
    }
}
