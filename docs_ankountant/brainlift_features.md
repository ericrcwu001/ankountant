...
- The TBS note type must accommodate all four TBS shapes up front — research / journal-entry / numeric / document-review — even if only some are authored initially (RAG *generation* of TBS items is Phase 2a).
